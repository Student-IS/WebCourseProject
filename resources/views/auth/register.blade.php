...
@section('content')
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="form-group row">
            <label for="name" class="col-4 col-form-label text-right">@lang('auth.name')</label>
            <div class="col-6">
                <input id="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" placeholder="@lang('auth.name')" value="{{ old('name') }}" required autofocus>
                @if ($errors->has('name'))
        ...
        <div class="form-group row">
            <label for="password-confirm" class="col-4 col-form-label text-md-right">@lang('auth.confirmPwd')</label>
            <div class="col-6">
